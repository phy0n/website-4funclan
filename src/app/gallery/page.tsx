...
export default function Gallery() {
 ...
 {t("gallery_title")}<span className="text-primary">.</span>
 </h1>
 ...
 className="relative flex-none w-[80vw] sm:w-[45vw] md:w-[35vw] lg:w-[25vw] aspect-[4/3] mx-3 md:mx-4 overflow-hidden bg-[#111] border border-white/5 group cursor-pointer hover:border-white/20 transition-all duration-300">
 <Image
 src={item.image}
 alt={item.title}
 fill
